...
export default function CartScreen() {
  ...
  const { billingCycles, operatingSystems, raidSetups, volumes } =
  ...
  return (
    <View className="flex-1 p-3">
      {products.length === 0 ? (
        <Texts className="text-xl text-center text-gray-500">
          Your cart is empty.
        </Texts>
      ) : (
        <>
              ...
              return (
                ...
                >
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      setExpandedProduct(
                        expandedProduct === item.id ? null : item.id,
                      )
                    }
                  >
                  ...
                  {expandedProduct === item.id && (
                    <>
                      ...
                      <Dropdown
                        ...
                        onChange={(selected) =>
                          updateProduct(item.id, "os", selected.value, 0)
                        }
                      />
                  ...
                  <TouchableOpacity
                    ...
                    className="w-full mt-2  mb-2 p-2 bg-indigo rounded-lg shadow-md items-center"
                  >
