...
export const useProductsStore = create<ProductsStore>((set, get) => ({
    products: [
        {id: 1, name: "2 Xeon Cores, 512MB RAM, 10GB SSD", price: {eur: 4.2, usd: 4.5, gbp: 3.8}, country: "Germany"},
        {id: 2, name: "3 Xeon Cores, 1GB RAM, 20GB SSD", price: {eur: 5.4, usd: 5.8, gbp: 4.9}, country: "France"},
        {
            id: 3,
        ...
        {id: 6, name: "6 Xeon Cores, 16GB RAM, 150GB SSD", price: {eur: 42.3, usd: 45.1, gbp: 38.7}, country: "France"},
        {
            id: 7,
        ...
        {id: 9, name: "12 Xeon Cores, 128GB RAM, 500GB SSD", price: {eur: 250, usd: 265, gbp: 228}, country: "Germany"},
        {id: 10, name: "16 Xeon Cores, 256GB RAM, 1TB SSD", price: {eur: 420, usd: 445, gbp: 380}, country: "France"},
        {
            id: 11,
